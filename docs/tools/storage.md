...
Контекстное хранилище как и любое другое хранилище удобно тем что его можно открыть и изменить из любого места в коде, а главное оно доступно из-коробки, [смотрите пример](https://github.com/vkbottle/vkbottle/blob/masterhttps://github.com/vkbottle/vkbottle/tree/master/examples/low-level/ctx_storage_example.py)
