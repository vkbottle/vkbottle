...
Хранилища как бы это не было очевидно нужны, что-бы хранить информацию в формате `ключ`: `значение`
...
* Имплементируйте методы `get`, `set`, `delete` и `contains` (указаны ранее) с подключением к `Rabbit MQ`
