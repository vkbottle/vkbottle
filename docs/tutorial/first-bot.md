...
Такой запрос создаст пост на стене группы/пользователя с указанным текстом, как вы видите параметры запроса принимаются в качестве аргументов (иде вам все подскажет)
...
* [easy-bot](https://github.com/timoniq/vkbottle/blob/master/examples/high-level/easy_bot.py)
