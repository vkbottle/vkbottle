...
from vkbottle.dispatch import ABCRouter, UserRouter, BuiltinStateDispenser
...
class User(ABCFramework):
    def __init__(
        ...
        self._polling = polling or UserPolling(self.api, self.user_id)
        self._router = router or UserRouter()
        self._loop = loop
